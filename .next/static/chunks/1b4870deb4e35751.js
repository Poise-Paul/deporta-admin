...
to {
  ...
  animation: ${G} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Q=({toast:e})=>{let{icon:t,type:a,iconTheme:s}=e;return void 0!==t?"string"==typeof t?r.createElement(V,null,t):t:"blank"===a?null:r.createElement(H,null,r.createElement(K,{...s}),"loading"!==a&&r.createElement(q,null,"error"===a?r.createElement(z,{...s}):r.createElement(F,{...s})))},Y=g("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,ee=({reverseOrder:e,position:t="top-center",toastOptions:a,gutter:s,children:i,toasterId:o,containerStyle:n,containerClassName:l})=>{let{toasts:d,handlers:c}=I(a,o);return r.createElement("div",{"data-rht-toaster":o||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...n},className:l,onMouseEnter:c.startPause,onMouseLeave:c.endPause},d.map(a=>{let o,n,l=a.position||t,d=c.calculateOffset(a,{reverseOrder:e,gutter:s,defaultPosition:t}),u=(o=l.includes("top"),n=l.includes("center")?{justifyContent:"center"}:l.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:v()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${d*(o?1:-1)}px)`,...o?{top:0}:{bottom:0},...n});return r.createElement(W,{id:a.id,key:a.id,onHeightUpdate:c.updateHeight,className:a.visible?X:"",style:u},"custom"===a.type?x(a.message,a):i?i(a):r.createElement(J,{toast:a,position:l}))}))};e.s(["CheckmarkIcon",()=>F,"ErrorIcon",()=>z,"LoaderIcon",()=>K,"ToastBar",()=>J,"ToastIcon",()=>Q,"Toaster",()=>ee,"default",()=>T,"resolveValue",()=>x,"toast",()=>T,"useToaster",()=>I,"useToasterStore",()=>A],5766)},9258,e=>{"use strict";let t=new(e.i(17751)).QueryClient({defaultOptions:{queries:{retry:2,staleTime:3e5}}});e.s(["queryClient",0,t])},88511,e=>{"use strict";let t=(0,e.i(75254).default)("SquarePen",[["path",{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",key:"1m0v6g"}],["path",{d:"M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z",key:"ohrbg2"}]]);e.s(["Edit",()=>t],88511)},27612,56940,e=>{"use strict";let t=(0,e.i(75254).default)("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);e.s(["Trash2",()=>t],27612),e.s(["NIGERIA_STATES",0,["Abia","Adamawa","Akwa Ibom","Anambra","Bauchi","Bayelsa","Benue","Borno","Cross River","Delta","Ebonyi","Edo","Ekiti","Enugu","FCT - Abuja","Gombe","Imo","Jigawa","Kaduna","Kano","Katsina","Kebbi","Kogi","Kwara","Lagos","Nasarawa","Niger","Ogun","Ondo","Osun","Oyo","Plateau","Rivers","Sokoto","Taraba","Yobe","Zamfara"]],56940)},48256,e=>{"use strict";let t=(0,e.i(75254).default)("Globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);e.s(["Globe",()=>t],48256)},18273,e=>{"use strict";var t=e.i(9e4),a=e.i(54616),s=e.i(5766),r=e.i(81949),i=e.i(9258),o=e.i(79239),n=e.i(54381);let l=async()=>{try{return(await t.api.get("/api/users/admin/pickup-station/get")).data}catch(e){throw console.error("Fetch User Error:",e),e}};e.s(["getPickupStations",0,l,"useCreatePickupStation",0,()=>(0,a.useMutation)({mutationFn:async e=>(await t.api.post("/api/users/admin/pickup-station/create",{address:e.address,area:e.area,state:e.state,country:e.country})).data,onSuccess:e=>(i.queryClient.invalidateQueries({queryKey:["pickupStations"]}),s.default.success(`${e.message}`),e),onError:(e,t)=>{if(r.default.isAxiosError(e)){let t=e.response?.data;console.log("User Erro",e),s.default.error(`${t?.error.message}`)}else console.error("❌ Unexpected error:",e)}}),"useDeletePickupStation",0,()=>(0,a.useMutation)({mutationFn:async e=>(await t.api.delete(`/api/users/admin/pickup-station/delete/${e}`)).data,onSuccess:e=>(i.queryClient.invalidateQueries({queryKey:["pickupStations"]}),s.default.success(`${e.message}`),e),onError:(e,t)=>{if(r.default.isAxiosError(e)){let t=e.response?.data;console.log("User Erro",e),s.default.error(`${t?.error.message}`)}else console.error("❌ Unexpected error:",e)}}),"useModifyPickupStation",0,()=>(0,a.useMutation)({mutationFn:async e=>(await t.api.patch("/api/users/admin/pickup-station/edit",{pickup_station_id:e.pickup_station_id,address:e.address,area:e.area,state:e.state,country:e.country})).data,onSuccess:e=>(i.queryClient.invalidateQueries({queryKey:["pickupStations"]}),o.store.dispatch((0,n.updatePickupDetails)(e.pickup_station)),s.default.success(`${e.message}`),e),onError:(e,t)=>{if(r.default.isAxiosError(e)){let t=e.response?.data;console.log("User Erro",e),s.default.error(`${t?.error.message}`)}else console.error("❌ Unexpected error:",e)}})])},5703,e=>{"use strict";var t=e.i(43476),a=e.i(71645),s=e.i(70065),r=e.i(67881),i=e.i(94179),o=e.i(69035),n=e.i(10708),l=e.i(30374),d=e.i(62870),c=e.i(46897),u=e.i(48256),p=e.i(87316),m=e.i(84614),h=e.i(71689),f=e.i(31278),y=e.i(27612),g=e.i(88511),x=e.i(47163),b=e.i(18273),v=e.i(55487),j=e.i(23750),k=e.i(53145),w=e.i(56940),C=e.i(5766),S=e.i(18566);function E({onBack:e}){let{selStation:E}=(0,v.useSelector)(e=>e.pickupStation),M=E?.status==="active",[O,A]=(0,a.useState)(!1),[P,T]=(0,a.useState)(!0),D=(0,b.useDeletePickupStation)(),I=(0,S.useRouter)(),{register:$,setValue:R,watch:_}=(0,k.useForm)({defaultValues:{address:E?.address,area:E?.area,state:E?.state,country:E?.country}}),z=_("state"),L=(0,b.useModifyPickupStation)(),{address:K,area:U,state:B,country:F}=_();return(0,a.useEffect)(()=>{K&&U&&B&&F?T(!1):T(!0)},[K,U,B,F]),(0,t.jsxs)("div",{className:"space-y-6",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between",children:[(0,t.jsxs)(r.Button,{variant:"ghost",onClick:e,className:"gap-2",children:[(0,t.jsx)(h.ArrowLeft,{className:"h-4 w-4"})," Back to Stations"]}),(0,t.jsxs)("div",{className:"flex gap-3",children:[(0,t.jsxs)(l.Dialog,{open:O,onOpenChange:A,children:[(0,t.jsx)(l.DialogTrigger,{asChild:!0,children:(0,t.jsxs)(r.Button,{variant:"outline",children:[(0,t.jsx)(g.Edit,{className:"h-4 w-4 mr-2"})," Edit Station"]})}),(0,t.jsxs)(l.DialogContent,{className:"sm:max-w-md",children:[(0,t.jsx)(l.DialogHeader,{children:(0,t.jsx)(l.DialogTitle,{children:"Edit Pickup Station"})}),(0,t.jsxs)("div",{className:"space-y-4 py-4",children:[(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsx)(n.Label,{htmlFor:"name",children:"Pickup Address"}),(0,t.jsx)(j.Input,{id:"name",...$("address"),placeholder:"Enter pickup station address"})]}),(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsx)(n.Label,{htmlFor:"area",children:"Area"}),(0,t.jsx)(j.Input,{id:"area",...$("area"),placeholder:"Enter area"})]}),(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsx)("label",{className:"text-sm font-medium",children:"State"}),(0,t.jsxs)(d.Select,{value:z,onValueChange:e=>R("state",e),children:[(0,t.jsx)(d.SelectTrigger,{className:"w-full bg-transparent border-border",children:(0,t.jsx)(d.SelectValue,{placeholder:"Select a State"})}),(0,t.jsx)(d.SelectContent,{children:w.NIGERIA_STATES.map(e=>(0,t.jsx)(d.SelectItem,{value:e.toLowerCase(),children:e},e))})]})]}),(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsx)(n.Label,{htmlFor:"state",children:"Country"}),(0,t.jsx)(j.Input,{id:"country",...$("country"),defaultValue:"Nigeria",placeholder:"Enter country"})]}),(0,t.jsx)(r.Button,{disabled:L.isPending||P,onClick:()=>{E&&L.mutate({pickup_station_id:E._id,address:K,area:U,state:B,country:F},{onSettled:()=>A(!1)})},className:`w-full bg-primary ${L.isPending||P?"opacity-30":""} hover:bg-primary/90 text-primary-foreground`,children:L.isPending?(0,t.jsx)(f.Loader2,{className:"h-4 w-4 animate-spin"}):(0,t.jsx)(t.Fragment,{children:"Update Pickup Station"})})]})]})]}),(0,t.jsxs)(r.Button,{variant:"destructive",onClick:()=>{var e;confirm("Permanently delete this station?")&&(e=E?._id||"",D.mutate(e,{onSettled:()=>I.push("/app-menu/pickup-stations")}))},disabled:D.isPending,children:[D.isPending?(0,t.jsx)(f.Loader2,{className:"animate-spin h-4 w-4"}):(0,t.jsx)(y.Trash2,{className:"h-4 w-4 mr-2"}),"Delete Station"]})]})]}),E&&(0,t.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-6",children:[(0,t.jsxs)(s.Card,{className:"lg:col-span-1 border-border",children:[(0,t.jsxs)(s.CardContent,{className:"pt-8 text-center",children:[(0,t.jsx)("div",{className:"h-20 w-20 bg-secondary/10 rounded-xl flex items-center justify-center mx-auto mb-4 text-secondary",children:(0,t.jsx)(c.MapPin,{className:"h-10 w-10"})}),(0,t.jsx)("h2",{className:"text-xl font-bold px-4",children:E?.address}),(0,t.jsx)("p",{className:"text-muted-foreground text-sm mb-4",children:E?.area}),(0,t.jsx)(i.Badge,{variant:"outline",className:(0,x.cn)(M?"border-green-500 text-green-600 bg-green-50":"border-orange-500 text-orange-600 bg-orange-50"),children:M?"Active Station":"In-active Station"})]}),(0,t.jsx)(o.Separator,{className:"my-6"}),(0,t.jsxs)(s.CardContent,{className:"space-y-4",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 text-sm",children:[(0,t.jsx)(u.Globe,{className:"h-4 w-4 text-muted-foreground"})," ",(0,t.jsxs)("span",{children:[E.state,", ",E.country]})]}),(0,t.jsxs)("div",{className:"flex items-center gap-3 text-sm",children:[(0,t.jsx)(m.User,{className:"h-4 w-4 text-muted-foreground"})," ",(0,t.jsxs)("span",{children:["Added by: ",E.added_by.first_name," ",E.added_by.last_name]})]})]})]}),(0,t.jsxs)(s.Card,{className:"lg:col-span-2 border-border",children:[(0,t.jsx)(s.CardHeader,{children:(0,t.jsx)(s.CardTitle,{className:"text-lg",children:"Pickup Station Details"})}),(0,t.jsxs)(s.CardContent,{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[(0,t.jsx)(N,{label:"Address",value:E.address,icon:(0,t.jsx)(c.MapPin,{})}),(0,t.jsx)(N,{label:"Area",value:E.area,icon:(0,t.jsx)(c.MapPin,{})}),(0,t.jsx)(N,{label:"State",value:E.state,icon:(0,t.jsx)(u.Globe,{})}),(0,t.jsx)(N,{label:"Country",value:E.country,icon:(0,t.jsx)(u.Globe,{})}),(0,t.jsx)(N,{label:"Date Created",value:new Date(E.createdAt).toDateString(),icon:(0,t.jsx)(p.Calendar,{})})]})]})]}),(0,t.jsx)(C.Toaster,{})]})}function N({label:e,value:a,icon:s}){return(0,t.jsxs)("div",{className:"flex items-start gap-3",children:[(0,t.jsx)("div",{className:"mt-1 text-muted-foreground [&_svg]:h-4 [&_svg]:w-4",children:s}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"text-xs font-medium text-muted-foreground uppercase",children:e}),(0,t.jsx)("p",{className:"text-sm capitalize font-semibold",children:a})]})]})}function M(){let e=(0,S.useRouter)();return(0,t.jsx)("div",{className:"space-y-6",children:(0,t.jsx)(E,{onBack:()=>e.back()})})}e.s(["default",()=>M],5703)}]);