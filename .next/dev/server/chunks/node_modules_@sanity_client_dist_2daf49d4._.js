module.exports = [
"[project]/node_modules/@sanity/client/dist/isRecord-Kfmt-nk-.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
 //# sourceMappingURL=isRecord-Kfmt-nk-.js.map
}),
"[project]/node_modules/@sanity/client/dist/request-BhMuKj0D.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/isRecord-Kfmt-nk-.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$errorGuards$2d$C36CfYld$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__r__as__createRequester$3e$__ = __turbopack_context__.i("[project]/node_modules/get-it/dist/errorGuards-C36CfYld.js [app-route] (ecmascript) <export r as createRequester>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$errorGuards$2d$C36CfYld$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__t__as__isHttpError$3e$__ = __turbopack_context__.i("[project]/node_modules/get-it/dist/errorGuards-C36CfYld.js [app-route] (ecmascript) <export t as isHttpError>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/get-it/dist/middleware.js [app-route] (ecmascript)");
...
*/ function codeFrame(query, location1, message) {
    let lines = query.split(NEWLINE), { start, end, markerLines } = getMarkerLines({
        start: columnToLine(location1.start, lines),
        end: location1.end ? columnToLine(location1.end, lines) : void 0
...
function getMarkerLines(loc, source) {
    ...
    if (lineDiff) for(let i = 0; i <= lineDiff; i++){
        ...
        markerLines[lineNumber] = startColumn ? i === 0 ? [
            startColumn,
            source[lineNumber - 1].length - startColumn + 1
        ] : i === lineDiff ? [
            0,
            endColumn
        ] : [
            0,
            source[lineNumber - i].length
        ] : !0;
    }
...
*/ function isHttpError$1(error) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(error)) return !1;
    let response = error.response;
    return !(typeof error.statusCode != "number" || typeof error.message != "string" || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(response) || response.body === void 0 || typeof response.url != "string" || typeof response.method != "string" || typeof response.headers != "object" || typeof response.statusCode != "number");
}
/** @public */ var ClientError = class extends Error {
    constructor(res, tag){
...
function extractErrorProps(res, tag) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(body)) return props.message = `${httpErrorMessage(res, body)}${formatTraceId(props.traceId)}`, props;
...
/** @internal */ function isQueryParseError(error) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(error) && error.type === "queryParseError" && typeof error.query == "string" && typeof error.start == "number" && typeof error.end == "number";
}
/**
...
/** @public */ var CorsOriginError = class extends Error {
...
*/ function defineRequester(envOptions, config = {}) {
    ...
    }, requester = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$errorGuards$2d$C36CfYld$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__r__as__createRequester$3e$__["createRequester"])({
        ...envOptions.fetch ? {
            fetch: envOptions.fetch
        } : {},
        headers: envOptions.headers,
        httpErrors: !0,
        middleware: [
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["retry"])({
    ...
    }, observable = (options)=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Observable"]((subscriber)=>{
            let controller = new AbortController(), userSignal = options.signal, signal = userSignal ? AbortSignal.any([
                userSignal,
                controller.signal
            ]) : controller.signal, subscription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["from"])(promise({
                ...options,
                signal
...
async function executeRequest(requester, fetchOptions) {
    ...
    try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$errorGuards$2d$C36CfYld$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__t__as__isHttpError$3e$__["isHttpError"])(err)) {
...
function shouldRetryRequest(err, attempt, options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$middleware$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRetryableRequest"])(err, attempt, options);
}
function printWarnings(config) {
    let seen = {}, shouldIgnore = (message)=>config.ignoreWarnings !== void 0 && (Array.isArray(config.ignoreWarnings) ? config.ignoreWarnings : [
            config.ignoreWarnings
        ]).some((pattern)=>typeof pattern == "string" ? message.includes(pattern) : pattern.test(message));
    return {
...
;
 //# sourceMappingURL=request-BhMuKj0D.js.map
}),
"[project]/node_modules/@sanity/client/dist/config-3wiPP-sZ.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const createWarningPrinter = (message)=>once((...args)=>console.warn(message.join(" "), ...args)), printCdnAndWithCredentialsWarning = createWarningPrinter([
...
]), printDeprecatedUriOptionWarning = createWarningPrinter([
...
const initConfig = (config, prevConfig)=>{
    ...
    let isBrowser = ("TURBOPACK compile-time value", "undefined") < "u" && window.location && window.location.hostname, isLocalhost = isBrowser && isLocal(window.location.hostname), hasToken = !!newConfig.token;
...
"[project]/node_modules/@sanity/client/dist/dist-Z8cIRxoB.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@sanity/client/dist/stegaClean-C18wLWau.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$dist$2d$Z8cIRxoB$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/dist-Z8cIRxoB.js [app-route] (ecmascript)");
;
/**
...
*/ function stegaClean(result) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$dist$2d$Z8cIRxoB$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(result);
}
/**
* Can take a `result` JSON from a `const {result} = client.fetch(query, params, {filterResponse: false})`
* and remove all stega-encoded data from it.
...
"[project]/node_modules/@sanity/client/dist/rolldown-runtime-vyAXikos.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$rolldown$2d$runtime$2d$vyAXikos$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/rolldown-runtime-vyAXikos.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/isRecord-Kfmt-nk-.js [app-route] (ecmascript)");
;
;
var studioPath_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$rolldown$2d$runtime$2d$vyAXikos$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])({
...
/** @internal */ function get(obj, path, defaultVal) {
...
/** @alpha */ function fromString(path) {
...
/** @internal */ const DRAFTS_FOLDER = "drafts", VERSION_FOLDER = "versions", DRAFTS_PREFIX = `${DRAFTS_FOLDER}.`, VERSION_PREFIX = `${VERSION_FOLDER}.`;
/** @internal */ function isDraftId(id) {
    return id.startsWith(DRAFTS_PREFIX);
}
/** @internal */ function isVersionId(id) {
    return id.startsWith(VERSION_PREFIX);
}
/** @internal */ function isPublishedId(id) {
...
/** @internal */ function getDraftId(id) {
    if (isVersionId(id)) {
...
/**  @internal */ function getVersionId(id, version) {
...
/** @internal */ function getPublishedId(id) {
...
/** @internal */ function isArray(value) {
...
*/ function walkMap(value, mappingFn, path = []) {
    if (isArray(value)) return value.map((v, idx)=>{
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(v)) {
            let _key = v._key;
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(value)) {
...
/** @internal */ function createEditUrl(options) {
...
/** @internal */ function resolveEditInfo(options) {
...
/** @internal */ function resolveStudioBaseRoute(studioUrl) {
...
"[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export f as getDraftId>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getDraftId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["f"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript)");
}),
"[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export p as getPublishedId>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getPublishedId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["p"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript)");
}),
"[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export m as getVersionFromId>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getVersionFromId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["m"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript)");
}),
"[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export h as getVersionId>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getVersionId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript)");
}),
"[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export g as isDraftId>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "isDraftId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["g"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript)");
}),
"[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export v as isVersionId>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "isVersionId",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["v"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript)");
}),
"[project]/node_modules/@sanity/client/dist/index.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/isRecord-Kfmt-nk-.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/config-3wiPP-sZ.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$stegaClean$2d$C18wLWau$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/stegaClean-C18wLWau.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$errorGuards$2d$C36CfYld$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__n__as__isTimeoutError$3e$__ = __turbopack_context__.i("[project]/node_modules/get-it/dist/errorGuards-C36CfYld.js [app-route] (ecmascript) <export n as isTimeoutError>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/rxjs/dist/cjs/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__f__as__getDraftId$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export f as getDraftId>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__p__as__getPublishedId$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export p as getPublishedId>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__m__as__getVersionFromId$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export m as getVersionFromId>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__h__as__getVersionId$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export h as getVersionId>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__g__as__isDraftId$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export g as isDraftId>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__v__as__isVersionId$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/dist/resolveEditInfo-Cz-smq3a.js [app-route] (ecmascript) <export v as isVersionId>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventsource$2f$dist$2f$EventSource$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/eventsource/dist/EventSource.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/client/node_modules/nanoid/index.js [app-route] (ecmascript) <locals>");
;
;
;
;
...
*/ var ConnectionFailedError = class extends Error {
    constructor(message, options = {}){
        ...
        super(message, errorOptions), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "name", "ConnectionFailedError"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "status", void 0), this.status = status;
    }
}, DisconnectError = class extends Error {
    constructor(message, reason, options = {}){
        super(message, options), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "name", "DisconnectError"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "reason", void 0), this.reason = reason;
    }
}, ChannelError = class extends Error {
    constructor(message, data){
        super(message), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "name", "ChannelError"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "data", void 0), this.data = data;
    }
}, MessageError = class extends Error {
    constructor(message, data, options = {}){
        super(message, options), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "name", "MessageError"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "data", void 0), this.data = data;
    }
}, MessageParseError = class extends Error {
    constructor(..._args){
        super(..._args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "name", "MessageParseError");
    }
};
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Observable"]((observer)=>{
        ...
        function onError(evt) {
            if ("data" in evt) {
                ...
                observer.error(parseError || !event ? new MessageParseError("Unable to parse EventSource error message", {
                    cause: parseError
                }) : new MessageError((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(event.data) && typeof event.data.message == "string" ? event.data.message : "", event));
                return;
            }
            if (evt.code !== void 0) {
            ...
            if (es.readyState === es.CLOSED) observer.error(new ConnectionFailedError("EventSource connection failed"));
                ...
                let type = "reconnect";
                isRequestedEvent(type) && observer.next({
                    type
                });
            }
        }
        ...
        function onMessage(message) {
            ...
            if (message.type === "disconnect") {
                observer.error(new DisconnectError(`Server disconnected client: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(event.data) && typeof event.data.reason == "string" && event.data.reason || "unknown error"}`));
                return;
            }
...
function extractErrorMessage(err, tag) {
    let error = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(err) ? err.error : void 0;
    if (!error) {
        let message = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(err) ? err.message : void 0;
        return typeof message == "string" && message || "Unknown listener error";
    }
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(error)) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["l"])(error)) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["o"])(error, tag);
...
/** @internal */ var BasePatch = class {
    constructor(selection, operations = {}){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "selection", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "operations", void 0), this.selection = selection, this.operations = operations;
    }
    /**
	...
	*/ diffMatchPatch(attrs) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["y"])("diffMatchPatch", attrs), this._assign("diffMatchPatch", attrs);
    }
    /**
	...
	*/ insert(at, selector, items) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["v"])(at, selector, items), this._assign("insert", {
            [at]: selector,
            items
        });
    }
	...
	*/ reset() {
    ...
    _assign(op, props, merge = !0) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["y"])(op, props), this.operations = Object.assign({}, this.operations, {
	...
	*/ clone() {
        return new ObservablePatch(this.selection, {
            ...this.operations
        }, _classPrivateFieldGet2(_client$11, this));
    }
    commit(options) {
        ...
        return _classPrivateFieldGet2(_client$11, this).mutate({
	...
	*/ clone() {
        return new Patch(this.selection, {
            ...this.operations
        }, _classPrivateFieldGet2(_client2$10, this));
    }
    commit(options) {
        ...
        return _classPrivateFieldGet2(_client2$10, this).mutate({
            patch: this.serialize()
        }, opts);
    }
};
...
/** @internal */ var BaseTransaction = class {
    constructor(operations = [], transactionId){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "operations", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "trxId", void 0), this.operations = operations, this.trxId = transactionId;
    }
    /**
	...
	*/ create(doc) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["y"])("create", doc), this._add({
            create: doc
        });
    }
    /**
	...
	*/ createIfNotExists(doc) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["y"])(op, doc), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["f"])(op, doc), this._add({
            [op]: doc
        });
    }
    /**
	...
	*/ delete(documentId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_"])("delete", documentId), this._add({
            delete: {
                id: documentId
            }
        });
	...
	*/ clone() {
        return new Transaction([
            ...this.operations
        ], _classPrivateFieldGet2(_client$10, this), this.trxId);
    }
    commit(options) {
        ...
        return _classPrivateFieldGet2(_client$10, this).mutate(this.serialize(), Object.assign({
	...
	*/ clone() {
        return new ObservableTransaction([
            ...this.operations
        ], _classPrivateFieldGet2(_client2$9, this), this.trxId);
    }
    commit(options) {
        ...
        return _classPrivateFieldGet2(_client2$9, this).mutate(this.serialize(), Object.assign({
            transactionId: this.trxId
        }, defaultMutateOptions, options || {}));
    }
    patch(patchOrDocumentId, patchOps) {
...
*/ function _fetchRequest(_stega, _params, options) {
    ...
    } : _stega, params = stega.enabled ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$stegaClean$2d$C18wLWau$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(_params) : _params, mapResponse = options.filterResponse === !1 ? (res)=>res : (res)=>res.result, { cache, next, ...opts } = {
...
/** @internal */ function _fetchObservable(client, httpRequest, _stega, query, _params = {}, options = {}) {
...
*/ function _fetch$1(client, httpRequest, _stega, query, _params = {}, options = {}) {
    ...
    return stega.enabled ? Promise.all([
        request,
        __turbopack_context__.A("[project]/node_modules/@sanity/client/dist/stegaEncodeSourceMap-YR3NQ3iz.js [app-route] (ecmascript, async loader)").then((n)=>n.n)
    ]).then(([res, { stegaEncodeSourceMap }])=>{
...
/** @internal */ function _getDocumentObservable(client, httpRequest, id, opts = {}) {
...
/** @internal */ function _getDocument(client, httpRequest, id, opts = {}) {
...
*/ function _getDocumentOptions(client, id, opts) {
    let docId = id;
    if (opts.releaseId) {
        let versionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__m__as__getVersionFromId$3e$__["getVersionFromId"])(id);
        if (!versionId) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__g__as__isDraftId$3e$__["isDraftId"])(id)) throw Error(`The document ID (\`${id}\`) is a draft, but \`options.releaseId\` is set as \`${opts.releaseId}\``);
            docId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__h__as__getVersionId$3e$__["getVersionId"])(id, opts.releaseId);
    ...
    return {
        ...
        tag: opts.tag,
        signal: opts.signal,
        query: opts.includeAllVersions === void 0 ? void 0 : {
...
/** @internal */ function _getDocumentsObservable(client, httpRequest, ids, opts = {}) {
...
/** @internal */ function _documentsExistsObservable(client, httpRequest, ids, opts = {}) {
...
/** @internal */ function _getReleaseDocumentsObservable(client, httpRequest, releaseId, opts = {}) {
...
/** @internal */ function _createIfNotExistsObservable(client, httpRequest, doc, options) {
    return _observe(options?.signal, (signal)=>_createIfNotExists(client, httpRequest, doc, {
            ...options,
            signal
        }));
}
/** @internal */ function _createOrReplaceObservable(client, httpRequest, doc, options) {
    return _observe(options?.signal, (signal)=>_createOrReplace(client, httpRequest, doc, {
            ...options,
            signal
        }));
}
/** @internal */ function _createVersionObservable(client, httpRequest, doc, publishedId, options) {
    return _observe(options?.signal, (signal)=>_createVersion(client, httpRequest, doc, publishedId, {
            ...options,
            signal
        }));
}
/** @internal */ function _createVersionFromBaseObservable(client, httpRequest, publishedId, baseId, releaseId, ifBaseRevisionId, options) {
...
/** @internal */ function _deleteObservable(client, httpRequest, selection, options) {
    return _observe(options?.signal, (signal)=>_delete$1(client, httpRequest, selection, {
            ...options,
            signal
        }));
}
/** @internal */ function _discardVersionObservable(client, httpRequest, versionId, purge = !1, options) {
    return _observe(options?.signal, (signal)=>_discardVersion(client, httpRequest, versionId, purge, {
            ...options,
            signal
        }));
}
/** @internal */ function _replaceVersionObservable(client, httpRequest, doc, options) {
    return _observe(options?.signal, (signal)=>_replaceVersion(client, httpRequest, doc, {
            ...options,
            signal
        }));
}
/** @internal */ function _unpublishVersionObservable(client, httpRequest, versionId, publishedId, options) {
    return _observe(options?.signal, (signal)=>_unpublishVersion(client, httpRequest, versionId, publishedId, {
            ...options,
            signal
        }));
}
/** @internal */ function _mutateObservable(client, httpRequest, mutations, options) {
...
*/ function _mutate(client, httpRequest, mutations, options) {
    let mut;
    return mut = mutations instanceof Patch || mutations instanceof ObservablePatch ? {
        patch: mutations.serialize()
    } : mutations instanceof Transaction || mutations instanceof ObservableTransaction ? mutations.serialize() : mutations, _dataRequest(client, httpRequest, "mutate", {
        mutations: Array.isArray(mut) ? mut : [
            mut
        ],
        transactionId: options && options.transactionId || void 0
    }, options);
...
*/ function _createIfNotExists(client, httpRequest, doc, options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["f"])("createIfNotExists", doc), _create$1(client, httpRequest, doc, "createIfNotExists", options);
}
/**
...
*/ function _createOrReplace(client, httpRequest, doc, options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["f"])("createOrReplace", doc), _create$1(client, httpRequest, doc, "createOrReplace", options);
}
/**
...
*/ function _createVersion(client, httpRequest, doc, publishedId, options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["f"])("createVersion", doc), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["p"])("createVersion", doc), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["a"])(), _action(client, httpRequest, {
...
*/ function _createVersionFromBase(client, httpRequest, publishedId, baseId, releaseId, ifBaseRevisionId, options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_"])("createVersion", baseId), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_"])("createVersion", publishedId), _action(client, httpRequest, {
        actionType: "sanity.action.document.version.create",
        publishedId,
        baseId,
        versionId: releaseId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__h__as__getVersionId$3e$__["getVersionId"])(publishedId, releaseId) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__f__as__getDraftId$3e$__["getDraftId"])(publishedId),
        ifBaseRevisionId
    }, options);
}
/**
...
*/ function _replaceVersion(client, httpRequest, doc, options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["f"])("replaceVersion", doc), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["p"])("replaceVersion", doc), _action(client, httpRequest, {
...
*/ function _prepareRequest(client, options) {
    options.uri !== void 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["o"])();
    let uri = options.uri || options.url;
    if (typeof uri != "string") throw TypeError("Request options must include a `url`");
    let config = client.config(), canUseCdn = options.canUseCdn === void 0 ? [
        "GET",
        "HEAD"
    ].indexOf(options.method || "GET") >= 0 && isData(client, uri) : options.canUseCdn, useCdn = (options.useCdn ?? config.useCdn) && canUseCdn, tag = options.tag && config.requestTagPrefix ? [
        config.requestTagPrefix,
        options.tag
    ].join(".") : options.tag || config.requestTagPrefix;
    if (tag && options.tag !== null && (options.query = {
        tag: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["d"])(tag),
        ...options.query
    }), [
        "GET",
        "HEAD",
        ...
        perspectiveOption !== void 0 && (perspectiveOption === "previewDrafts" && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["c"])(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["r"])(perspectiveOption), options.query = {
            perspective: Array.isArray(perspectiveOption) ? perspectiveOption.join(",") : perspectiveOption,
            ...options.query
        }, (Array.isArray(perspectiveOption) && perspectiveOption.length > 0 || perspectiveOption === "previewDrafts" || perspectiveOption === "drafts") && useCdn && (useCdn = !1, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["i"])()));
    ...
    return requestOptions(config, Object.assign({}, options, {
...
*/ function _observe(userSignal, run) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Observable"]((subscriber)=>{
        ...
        return run(userSignal ? AbortSignal.any([
            userSignal,
            controller.signal
...
*/ function _uploadObservable(client, options) {
    let reqOptions = _prepareRequest(client, options), requester = client.config().requester, request = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Observable"]((subscriber)=>requester(reqOptions).subscribe(subscriber)).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["filter"])((event)=>event?.type === "progress" || event?.type === "response"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])((event)=>event.type === "progress" ? {
            type: "progress",
            stage: event.stage,
...
*/ function _getDataUrl(client, operation, path) {
    let config = client.config();
    if (config.resource) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["m"])(config), `${resourceDataBase(config)}/${path === void 0 ? operation : `${operation}/${path}`}`.replace(/\/($|\?)/, "$1");
    let baseUri = `/${operation}/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(config)}`;
...
function _generateObservable(client, httpRequest, request) {
    return _requestObservable(client, httpRequest, {
        method: "POST",
        url: `/agent/action/generate/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(client.config())}`,
        body: request
    });
}
...
function _patch(client, httpRequest, request) {
    return _request(client, httpRequest, {
        method: "POST",
        url: `/agent/action/patch/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(client.config())}`,
        body: request
    });
}
function _prompt(client, httpRequest, request) {
    return _request(client, httpRequest, {
        method: "POST",
        url: `/agent/action/prompt/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(client.config())}`,
        body: request
    });
}
function _transformObservable(client, httpRequest, request) {
    return _requestObservable(client, httpRequest, {
        method: "POST",
        url: `/agent/action/transform/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(client.config())}`,
        body: request
    });
}
...
function _translateObservable(client, httpRequest, request) {
    return _requestObservable(client, httpRequest, {
        method: "POST",
        url: `/agent/action/translate/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(client.config())}`,
        body: request
    });
}
...
var _client$9 = /* @__PURE__ */ new WeakMap(), _httpRequest$8 = /* @__PURE__ */ new WeakMap(), ObservableAgentsActionClient = class {
	...
	*/ patch(request) {
    ...
    upload(assetType, body, options) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(observable.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["filter"])((event)=>event.type === "response"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])((event)=>pluckUploadedAsset(event.body))));
    }
};
/**
...
function _upload(client, _httpRequest, assetType, body, opts = {}) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["g"])(assetType);
    ...
    return typeof XMLHttpRequest < "u" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["defer"])(async ()=>{
        let { uploadWithProgress } = await __turbopack_context__.A("[project]/node_modules/@sanity/client/dist/browserUpload-CwpNx7Vl.js [app-route] (ecmascript, async loader)"), req = _prepareRequest(client, {
            ...baseRequest
        });
    ...
    }).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeAll"])()) : _uploadObservable(client, baseRequest);
}
function appendQuery(url, query) {
    if (!query) return url;
    let qs = (query instanceof URLSearchParams ? query : new URLSearchParams(Object.entries(query).flatMap(([key, value])=>value == null ? [] : [
            [
                key,
                `${value}`
            ]
...
function buildAssetUploadUrl(config, assetType) {
    ...
    return `assets/${assetTypeEndpoint}/${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(config)}`;
}
...
const pick = (obj, props)=>props.reduce((selection, prop)=>(obj[prop] === void 0 || (selection[prop] = obj[prop]), selection), {}), RETRYABLE_STATUSES = /* @__PURE__ */ new Set([
    408,
    429
]);
/**
...
*/ function resolveEventSourceFetch(config, options = {}) {
    ...
    return function eventSourceFetch(url, init) {
        let baseFetch = pickBaseFetch(config), mergedInit = {
            ...init
        };
        if (extraHeaders) {
...
/** @internal */ const possibleOptions = [
...
/** @public */ function _listen$1(query, params, opts = {}) {
    let { url, requestTagPrefix } = this.config(), tag = opts.tag && requestTagPrefix ? [
        requestTagPrefix,
        opts.tag
    ...
    if (uri.length > 14800) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["throwError"])(()=>/* @__PURE__ */ Error("Query too large for listener"));
    let listenFor = options.events ? options.events : [
        "mutation"
    ];
    return _connectListenEventSource(this, uri, listenFor);
}
/** @internal */ function _connectListenEventSource(client, uri, listenFor) {
    ...
    let initEventSource = ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventsource$2f$dist$2f$EventSource$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EventSource"](uri, {
            fetch: resolveEventSourceFetch(config, {
                headers: Object.keys(headers).length ? headers : void 0,
                withCredentials
            })
        });
    return connectEventSource(initEventSource, listenFor).pipe(reconnectOnConnectionFailure(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["filter"])((event)=>listenFor.includes(event.type)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])((event)=>({
            type: event.type,
            ..."data" in event ? event.data : {}
        })));
}
/** @internal */ const possibleRequestOptions = [
    "headers",
    "signal",
    "tag",
    "timeout",
...
/** @internal */ function _getTargetDocumentRef(client, documentId) {
    if (!documentId) throw Error("Document ID must be provided");
    let resource = resolveCommentResource(client);
    return `${resource.type}:${resource.id}:${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__p__as__getPublishedId$3e$__["getPublishedId"])(documentId)}`;
}
...
*/ function writeDocument(commentId, ...args) {
    return write(...args).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])(({ results })=>{
...
function writeMutationResult(...args) {
    return write(...args).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])(({ transactionId, results })=>({
            transactionId,
            documentIds: results.map((result)=>result.id),
            results
        })));
}
/** @internal */ function _create(client, httpRequest, body, options) {
    return writeDocument(body._id, client, httpRequest, "POST", "/collaboration/comments", body, options);
}
/** @internal */ function _update(client, httpRequest, id, body, options) {
    return writeDocument(id, client, httpRequest, "PATCH", commentUrl(id), body, options);
}
/** @internal */ function _delete(client, httpRequest, id, options) {
    return writeMutationResult(client, httpRequest, "DELETE", commentUrl(id), void 0, options);
}
/** @internal */ function _addReaction(client, httpRequest, id, shortName, options) {
    return writeDocument(id, client, httpRequest, "POST", `${commentUrl(id)}/reactions`, {
        shortName
    }, options);
}
/** @internal */ function _removeReaction(client, httpRequest, id, shortName, options) {
    return writeDocument(id, client, httpRequest, "DELETE", `${commentUrl(id)}/reactions/${encodeURIComponent(shortName)}`, void 0, options);
}
/** @internal */ function _fetch(client, httpRequest, query, params, options) {
    ...
    return _requestObservable(client, httpRequest, {
        ...
        ...pick(options || {}, possibleRequestOptions)
    }).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])((response)=>response.result));
}
/** @internal */ function _listen(client, query, params, options) {
    let opts = options ?? {}, { requestTagPrefix } = client.config(), tag = opts.tag && requestTagPrefix ? [
        requestTagPrefix,
        opts.tag
    ].join(".") : opts.tag, listenOpts = pick({
        ...defaults_default(opts, defaultOptions),
        tag
    ...
    return uri.length > 14800 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["throwError"])(()=>/* @__PURE__ */ Error("Query too large for listener")) : _connectListenEventSource(client, uri, opts.events ? opts.events : [
        "mutation"
    ]);
}
var _client$7 = /* @__PURE__ */ new WeakMap(), _httpRequest$7 = /* @__PURE__ */ new WeakMap(), ObservableCollaborationCommentsClient = class {
	...
	* @returns The created comment
	*/ create(body, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(_create(_classPrivateFieldGet2(_client2$6, this), _classPrivateFieldGet2(_httpRequest2$7, this), body, options));
    }
    /**
	* Update an existing comment.
	*
	...
	* @returns The updated comment
	*/ update(id, body, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(_update(_classPrivateFieldGet2(_client2$6, this), _classPrivateFieldGet2(_httpRequest2$7, this), id, body, options));
    }
    /**
	* Delete a comment and its replies.
	*
	...
	* @returns Mutation result, where `documentIds` covers the comment and every deleted reply
	*/ delete(id, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(_delete(_classPrivateFieldGet2(_client2$6, this), _classPrivateFieldGet2(_httpRequest2$7, this), id, options));
    }
    /**
	* Add the current user's reaction to a comment.
	*
	...
	* @returns The comment, with the reaction applied
	*/ addReaction(id, shortName, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(_addReaction(_classPrivateFieldGet2(_client2$6, this), _classPrivateFieldGet2(_httpRequest2$7, this), id, shortName, options));
    }
    /**
	* Remove the current user's reaction from a comment.
	*
	...
	* @returns The comment, with the reaction removed
	*/ removeReaction(id, shortName, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(_removeReaction(_classPrivateFieldGet2(_client2$6, this), _classPrivateFieldGet2(_httpRequest2$7, this), id, shortName, options));
    }
    /**
	* Build the global document reference used by `target.document._ref`, for use in
	* queries and listeners.
	...
	* @param options - Optional request options
	*/ fetch(query, params, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(_fetch(_classPrivateFieldGet2(_client2$6, this), _classPrivateFieldGet2(_httpRequest2$7, this), query, params, options));
    }
    listen(query, params, options) {
...
function _shareReplayLatest(config) {
    return (source)=>{
        let latest, emitted = !1, { predicate, ...shareConfig } = config, wrapped = source.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tap"])((value)=>{
...
var _client$6 = /* @__PURE__ */ new WeakMap(), LiveClient = class {
	...
	*/ events({ includeDrafts = !1, tag: _tag, waitFor } = {}) {
        ...
        let path = _getDataUrl(_classPrivateFieldGet2(_client$6, this), "live/events"), url = new URL(_classPrivateFieldGet2(_client$6, this).getUrl(path, !1)), tag = _tag && requestTagPrefix ? [
            requestTagPrefix,
            _tag
        ].join(".") : _tag;
        ...
        let initEventSource = ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventsource$2f$dist$2f$EventSource$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EventSource"](url.href, {
                fetch: resolveEventSourceFetch(config, {
            ...
            "reconnect",
            "goaway"
        ]), checkCors = checkCorsObservable(new URL(_classPrivateFieldGet2(_client$6, this).getUrl("/check/cors", !1)), projectId, eventSourceWithCredentials, pickBaseFetch(config)), observable = events.pipe(reconnectOnConnectionFailure(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeMap"])((event)=>event.type === "reconnect" ? checkCors.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeMap"])(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["of"])(event))) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["of"])(event)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["catchError"])((err)=>err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["i"] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["throwError"])(()=>err) : checkCors.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeMap"])(()=>{
                throw err;
            ...
            return event;
        })).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["finalize"])(()=>{
...
*/ function checkCorsObservable(url, projectId, requireCredentials, fetcher) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Observable"]((observer)=>{
        ...
        return fetcher(url.href, {
            ...
            let parsed = text === void 0 ? void 0 : JSON.parse(text), result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(parsed) ? parsed.result : void 0;
            if (requireCredentials && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(result) && result.withCredentials === !1) {
                observer.error(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["i"]({
                    projectId,
                    credentials: !0
                }));
                return;
            }
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$isRecord$2d$Kfmt$2d$nk$2d2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(result) && result.allowed === !1) {
                observer.error(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["i"]({
                    projectId,
...
var _client$5 = /* @__PURE__ */ new WeakMap(), _httpRequest$6 = /* @__PURE__ */ new WeakMap(), ObservableDatasetsClient = class {
	...
	*/ list() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", _classPrivateFieldGet2(_client$5, this).config());
	...
	*/ getEmbeddingsSettings(name) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", _classPrivateFieldGet2(_client$5, this).config()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["l"])(name), _requestObservable(_classPrivateFieldGet2(_client$5, this), _classPrivateFieldGet2(_httpRequest$6, this), {
	...
	* @param options - Options for the dataset, including optional embeddings configuration
	*/ create(name, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", _classPrivateFieldGet2(_client2$5, this).config()), _modify(_classPrivateFieldGet2(_client2$5, this), _classPrivateFieldGet2(_httpRequest2$6, this), "PUT", name, options);
    }
    /**
	* Edit a dataset with the given name
	*
	...
	* @param options - New options for the dataset
	*/ edit(name, options) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", _classPrivateFieldGet2(_client2$5, this).config()), _modify(_classPrivateFieldGet2(_client2$5, this), _classPrivateFieldGet2(_httpRequest2$6, this), "PATCH", name, options);
    }
    /**
	* Delete a dataset with the given name
	*
	* @param name - Name of the dataset to delete
	*/ delete(name) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", _classPrivateFieldGet2(_client2$5, this).config()), _modify(_classPrivateFieldGet2(_client2$5, this), _classPrivateFieldGet2(_httpRequest2$6, this), "DELETE", name);
    }
    /**
	* Fetch a list of datasets for the configured project
	*/ list() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", _classPrivateFieldGet2(_client2$5, this).config());
	...
	* @param name - Name of the dataset
	*/ getEmbeddingsSettings(name) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", _classPrivateFieldGet2(_client2$5, this).config()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["l"])(name), _request(_classPrivateFieldGet2(_client2$5, this), _classPrivateFieldGet2(_httpRequest2$6, this), {
...
function _modifyObservable(client, httpRequest, method, name, options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", client.config()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["l"])(name), _requestObservable(client, httpRequest, {
        method,
        url: `/datasets/${name}`,
        body: options,
        tag: null
...
function _modify(client, httpRequest, method, name, options) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["h"])("dataset", client.config()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["l"])(name), _request(client, httpRequest, {
        method,
        url: `/datasets/${name}`,
        body: options,
        tag: null
...
/** Function resource types in a blueprint are namespaced under this prefix. */ const scopeHeaders = (config, request)=>{
...
*/ function _resolveFunctionId(client, httpRequest, functionName, stackId, headers, request) {
    ...
    }).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])((stack)=>{
...
/** @internal */ function _invoke(client, httpRequest, functionName, request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["defer"])(()=>{
        let config = client.config(), headers = scopeHeaders(config, request);
        return _resolveFunctionId(client, httpRequest, functionName, resolveStackId(config, request), headers, request).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeMap"])((functionId)=>_requestObservable(client, httpRequest, {
                method: "POST",
...
var _client$4 = /* @__PURE__ */ new WeakMap(), _httpRequest$5 = /* @__PURE__ */ new WeakMap(), ObservableFunctionsClient = class {
	...
	* @param request - payload and request options
	*/ invoke(functionName, request) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastValueFrom"])(_invoke(_classPrivateFieldGet2(_client2$4, this), _classPrivateFieldGet2(_httpRequest2$5, this), functionName, request));
    }
...
/** @internal */ function isSanityReference(assetIdentifier) {
...
var _client$2 = /* @__PURE__ */ new WeakMap(), _httpRequest$3 = /* @__PURE__ */ new WeakMap(), ObservableProjectsClient = class {
	...
	*/ getById(projectId) {
        return _requestObservable(_classPrivateFieldGet2(_client$2, this), _classPrivateFieldGet2(_httpRequest$3, this), {
	...
	* @param projectId - ID of the project to fetch
	*/ getById(projectId) {
        return _request(_classPrivateFieldGet2(_client2$2, this), _classPrivateFieldGet2(_httpRequest2$3, this), {
            url: `/projects/${projectId}`
        });
    }
};
...
*/ const generateReleaseId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["customAlphabet"])("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", 8), getDocumentVersionId = (publishedId, releaseId)=>releaseId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__h__as__getVersionId$3e$__["getVersionId"])(publishedId, releaseId) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__f__as__getDraftId$3e$__["getDraftId"])(publishedId);
/** @internal */ function deriveDocumentVersionId(op, { releaseId, publishedId, document }) {
    if (publishedId && document._id) {
        let versionId = getDocumentVersionId(publishedId, releaseId);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["b"])(versionId, document), versionId;
    }
    if (document._id) {
        let isDraft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__g__as__isDraftId$3e$__["isDraftId"])(document._id), isVersion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__v__as__isVersionId$3e$__["isVersionId"])(document._id);
        ...
        if (releaseId) {
            ...
            let builtVersionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__m__as__getVersionFromId$3e$__["getVersionFromId"])(document._id);
...
var _client$1 = /* @__PURE__ */ new WeakMap(), _httpRequest$2 = /* @__PURE__ */ new WeakMap(), ObservableReleasesClient = class {
	...
	*/ get({ releaseId }, options) {
    ...
    create(releaseOrOptions, maybeOptions) {
        ...
        return _actionObservable(_classPrivateFieldGet2(_client$1, this), _classPrivateFieldGet2(_httpRequest$2, this), action, options).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])((actionResult)=>({
                ...actionResult,
                releaseId,
                metadata
            })));
	...
	*/ getById(id) {
        return _requestObservable(_classPrivateFieldGet2(_client, this), _classPrivateFieldGet2(_httpRequest$1, this), {
            url: `/users/${id}`
        });
    }
	...
	* @param id - User ID of the user to fetch. If `me` is provided, a minimal response including the users role is returned.
	*/ getById(id) {
        return _request(_classPrivateFieldGet2(_client2, this), _classPrivateFieldGet2(_httpRequest2$1, this), {
            url: `/users/${id}`
        });
    }
}, _clientConfig = /* @__PURE__ */ new WeakMap(), _httpRequest = /* @__PURE__ */ new WeakMap(), ObservableSanityClient = class ObservableSanityClient {
    constructor(httpRequest, config = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"]){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "assets", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "datasets", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "live", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "mediaLibrary", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "projects", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "users", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "agent", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "collaboration", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "functions", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "releases", void 0), _classPrivateFieldInitSpec(this, _clientConfig, void 0), _classPrivateFieldInitSpec(this, _httpRequest, void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, /**
			* Instance properties
			*/ "listen", _listen$1), this.config(config), _classPrivateFieldSet2(_httpRequest, this, httpRequest), this.assets = new ObservableAssetsClient(this, _classPrivateFieldGet2(_httpRequest, this)), this.datasets = new ObservableDatasetsClient(this, _classPrivateFieldGet2(_httpRequest, this)), this.live = new LiveClient(this), this.mediaLibrary = {
            video: new ObservableMediaLibraryVideoClient(this, _classPrivateFieldGet2(_httpRequest, this))
        }, this.projects = new ObservableProjectsClient(this, _classPrivateFieldGet2(_httpRequest, this)), this.users = new ObservableUsersClient(this, _classPrivateFieldGet2(_httpRequest, this)), this.agent = {
            action: new ObservableAgentsActionClient(this, _classPrivateFieldGet2(_httpRequest, this))
        }, this.collaboration = {
            comments: new ObservableCollaborationCommentsClient(this, _classPrivateFieldGet2(_httpRequest, this))
        }, this.functions = new ObservableFunctionsClient(this, _classPrivateFieldGet2(_httpRequest, this)), this.releases = new ObservableReleasesClient(this, _classPrivateFieldGet2(_httpRequest, this));
    }
    /**
	...
	*/ clone() {
    ...
    config(newConfig) {
        if (newConfig === void 0) return {
            ..._classPrivateFieldGet2(_clientConfig, this)
        };
        ...
        return _classPrivateFieldSet2(_clientConfig, this, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["n"])(newConfig, _classPrivateFieldGet2(_clientConfig, this) || {})), this;
    }
    /**
	...
	*/ documentsExists(ids, options) {
    ...
    createVersion({ document, publishedId, releaseId, baseId, ifBaseRevisionId }, options) {
        ...
        }, versionPublishedId = publishedId || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__p__as__getPublishedId$3e$__["getPublishedId"])(document._id);
	...
	*/ unpublishVersion({ releaseId, publishedId }, options) {
        let versionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$resolveEditInfo$2d$Cz$2d$smq3a$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__h__as__getVersionId$3e$__["getVersionId"])(publishedId, releaseId);
	...
	*/ getDataUrl(operation, path) {
    ...
    constructor(httpRequest, config = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"]){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "assets", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "datasets", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "live", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "mediaLibrary", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "projects", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "users", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "agent", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "collaboration", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "functions", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, "releases", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, /**
			* Observable version of the Sanity client, with the same configuration as the promise-based one
			*/ "observable", void 0), _classPrivateFieldInitSpec(this, _clientConfig2, void 0), _classPrivateFieldInitSpec(this, _httpRequest2, void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["u"])(this, /**
			* Instance properties
			*/ "listen", _listen$1), this.config(config), _classPrivateFieldSet2(_httpRequest2, this, httpRequest), this.assets = new AssetsClient(this, _classPrivateFieldGet2(_httpRequest2, this)), this.datasets = new DatasetsClient(this, _classPrivateFieldGet2(_httpRequest2, this)), this.live = new LiveClient(this), this.mediaLibrary = {
            video: new MediaLibraryVideoClient(this, _classPrivateFieldGet2(_httpRequest2, this))
        }, this.projects = new ProjectsClient(this, _classPrivateFieldGet2(_httpRequest2, this)), this.users = new UsersClient(this, _classPrivateFieldGet2(_httpRequest2, this)), this.agent = {
            action: new AgentActionsClient(this, _classPrivateFieldGet2(_httpRequest2, this))
        }, this.collaboration = {
            comments: new CollaborationCommentsClient(this, _classPrivateFieldGet2(_httpRequest2, this))
        }, this.functions = new FunctionsClient(this, _classPrivateFieldGet2(_httpRequest2, this)), this.releases = new ReleasesClient(this, _classPrivateFieldGet2(_httpRequest2, this)), this.observable = new ObservableSanityClient(httpRequest, config);
    }
    /**
	* Clone the client - returns a new instance
	*/ clone() {
    ...
    config(newConfig) {
        if (newConfig === void 0) return {
            ..._classPrivateFieldGet2(_clientConfig2, this)
        };
        ...
        return this.observable && this.observable.config(newConfig), _classPrivateFieldSet2(_clientConfig2, this, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["n"])(newConfig, _classPrivateFieldGet2(_clientConfig2, this) || {})), this;
    }
    /**
	* Clone the client with a new (partial) configuration.
	*
...
*/ function defineCreateClientExports(envOptions, ClassConstructor) {
    let defaultRequester = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(envOptions).observable, createClient = (config)=>{
        let { observable: clientRequester, promise: clientRequesterPromise } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$request$2d$BhMuKj0D$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["t"])(envOptions, {
...
function defineDeprecatedCreateClient(createClient) {
    return function deprecatedCreateClient(config) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$config$2d$3wiPP$2d$sZ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["s"])(), createClient(config);
    };
}
...
//# sourceMappingURL=node_modules_%40sanity_client_dist_2daf49d4._.js.map