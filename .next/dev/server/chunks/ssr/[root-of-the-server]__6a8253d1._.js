...
function VehicleRentalsStats() {
    const { data: ongoingTrips } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "ongoingTotal"
        ],
        queryFn: ()=>getTotal()
