    ...
    const { paginatedData, totalPages } = React.useMemo({
        "DashboardCustomers.useMemo": ()=>{
            ...
            let filtered = allCustomers.filter({
                "DashboardCustomers.useMemo.filtered": (station)=>{
            ...
            if (activeTab === "active") {
                filtered = filtered.filter({
                    "DashboardCustomers.useMemo": (s)=>s.status === "active"
                }["DashboardCustomers.useMemo"]);
            } else if (activeTab === "inactive") {
                filtered = filtered.filter({
                    "DashboardCustomers.useMemo": (s)=>s.status === "in-active"
                }["DashboardCustomers.useMemo"]);
            }
            return {
...
_s(DashboardCustomers, "UxaBcOmgtQd1bmCYlU0WpLQ/s50=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"],
...
//# sourceMappingURL=_e4de443e._.js.map