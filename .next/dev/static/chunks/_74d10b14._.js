    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useStatusUpdate.useMutation": async (data)=>{
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].patch(`/staff/status/${data.staffId}`, {
                    status: newStatus
                });
        ...
        onError: {
            "useStatusUpdate.useMutation": (error)=>{
                console.error(error);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update staff status");
            }
        }["useStatusUpdate.useMutation"]
    });
};
...
"[project]/components/staff/staff-details.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function StaffDetailPage({ staff, onBack }) {
    _s();
    const isActive = staff?.user_type?.type_id?.status === "active";
    const currentStatus = staff?.user_type?.type_id?.status;
    ...
    const handleStatusChange = ()=>{
        statusMutation.mutate({
            staffId: staff?._id || "",
            isActive: currentStatus === "active" ? __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveType"].Active : __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveType"].InActive
        });
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InfoItem, {
                                                label: "System Role",
                                                value: staff.user_type?.type_id?.role,
...
_s(StaffDetailPage, "AQ2vNqT9WebCzrL1YA8T2JVdVMw=", false, function() {
    return [
...
//# sourceMappingURL=_74d10b14._.js.map