...
function LoginForm() {
    ...
    const loginUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$onboarding$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoginUser"])();
    const onSubmit = async (data)=>{
        ...
        loginUser.mutate({
            ...
            onSuccess: (res)=>{
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$slices$2f$auth$2d$slice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])({
                    user: {
                        id: "1",
...
_s(LoginForm, "I1edo34Cw/MTezwqUaOAlGlZwHE=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$onboarding$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoginUser"]
    ];
});
_c = LoginForm;
var _c;
...
//# sourceMappingURL=_6bf484ba._.js.map